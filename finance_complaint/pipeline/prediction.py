...
class PredictionPipeline:
    ...
    def start_batch_prediction(self):
        try:
            ...
            #dummy invalid_files just to log what will happen if we get invalid file. Uncomment "Move"
            ...
            for valid_file in valid_files:
                ...
                #drop is not required during prediction as we will not get any data with target column
