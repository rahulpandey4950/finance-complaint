...
# Used to replace categorical to numerical using frequency count of each column
...
# Derived input from other input feature
...
# Used to replace missing value with most occured valued from each column
